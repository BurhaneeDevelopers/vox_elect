...
import { ChatHistoryProvider, useChatHistory } from '@/context/chat_history_context';
      ...
      <AuthGuard>
        <ChatHistoryProvider>
          <ChatPageContent
            ...
            set_info_panel_open={set_info_panel_open}
          />
        </ChatHistoryProvider>
      </AuthGuard>
    </QueryClientProvider>
...
function ChatPageContent({
  ...
  set_info_panel_open: (open: boolean) => void;
}) {
  const { start_new_chat } = useChatHistory();
